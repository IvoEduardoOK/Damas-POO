...
public class Tabuleiro {
	...
	//Lista contendo objetos do tipo peça
		...
		public boolean isMovimentoValido(String posicao, Peca peca)
		{
			...
			{
				if(Character.getNumericValue(posicao.charAt(0)) < peca.posicaoAtualX
						&& peca.cor == "Branca" && (Character.getNumericValue(posicao.charAt(1)) - peca.posicaoAtualY) == 1 
						|| (Character.getNumericValue(posicao.charAt(1)) - peca.posicaoAtualY) == -1 
						&& Character.getNumericValue(posicao.charAt(0)) - peca.posicaoAtualX == 1 || Character.getNumericValue(posicao.charAt(0)) - peca.posicaoAtualX == -1)
				{
